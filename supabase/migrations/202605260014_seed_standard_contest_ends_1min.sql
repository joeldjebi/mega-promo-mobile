-- MegaPromo - Nouveau jeu concours standard qui se termine dans 1 minute
...
-- Script idempotent: cree/met a jour un nouveau jeu concours tirage actif,
-- non-live, qui se termine 1 minute apres execution.
...
contest_seed as (
  ...
  select
    '20260526-0000-4000-9000-000000000501'::uuid,
    null,
    'Jeu Minute Bon Reduction',
    'Participe maintenant: le gagnant du bon de reduction est designe dans une minute.',
...
draw_settings_seed as (
  ...
  values (
    ...
    1,
    2,
    'Ta participation au Jeu Minute Bon Reduction est enregistree.',
    now() + interval '1 minute',
...
where contests.id = '20260526-0000-4000-9000-000000000501'::uuid;

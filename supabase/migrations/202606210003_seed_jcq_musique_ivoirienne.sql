-- MegaPromo - JCQ Musique ivoirienne
-- A exécuter dans Supabase SQL Editor après:
-- 202606210002_seed_musique_ivoirienne_200_questions.sql.
--
-- Objectif:
-- - créer un JCQ gratuit de 10 questions;
-- - le rattacher à la catégorie "Musique";
-- - tirer les questions depuis la Banque Musique;
...
reward_seed as (
  ...
  values (
    '20260621-0000-4000-e000-000000000701'::uuid,
    'Crédit JCQ Musique ivoirienne MegaPromo',
    'voucher',
    'Crédit promotionnel offert au gagnant du JCQ Musique ivoirienne.',
    'Crédit 2 000 FCFA',
    2000,
    null,
    'JCQ-MUSIQUE-2000',
    ...
    0,
    true,
    '{"seed": true, "free_quiz": true, "no_purchase_required": true, "question_source": "musique_question_bank"}'::jsonb,
    now(),
    now()
  )
...
contest_seed as (
  ...
  select
    '20260621-0000-4000-c000-000000000701'::uuid,
    null,
    'Connais-tu la musique ivoirienne ?',
    'Un JCQ gratuit de 10 questions sur le zouglou, le coupé-décalé, le reggae, le zoblazo, le rap ivoire et les traditions musicales.',

-- MegaPromo - 1 Quiz Live dans 5 minutes + 3 jeux concours 1h
...
-- Script idempotent: cloture les QL expires, cree/met a jour 1 QL actif
-- et 3 jeux concours standards actifs avec 2 gagnants chacun.
...
standard_seed as (
  ...
  join (
    values
      (
        '20260525-0000-4000-d000-000000000101'::uuid,
        'Jeu Concours Code MegaPromo',
        'Participe et tente de gagner un code reduction utilisable chez un partenaire.',
      ...
      (
        '20260525-0000-4000-d000-000000000102'::uuid,
        'Jeu Concours Bon Achat',
        'Un concours rapide pour tenter de gagner un bon de reduction.',
      ...
      (
        '20260525-0000-4000-d000-000000000103'::uuid,
        'Jeu Concours Lot Surprise',
        'Tente ta chance pour remporter un lot physique surprise.',
...
live_seed as (
  ...
  select
    '20260525-0000-4000-d000-000000000201'::uuid,
    null,
    'QL Reflexe MegaPromo',
    'Quiz Live express: marques, logique et culture generale. Depart dans 5 minutes.',
...
questions_seed as (
  ...
  values
    (
      '20260525-0000-4000-d000-000000000211'::uuid,
      '20260525-0000-4000-d000-000000000201'::uuid,
    ...
    (
      '20260525-0000-4000-d000-000000000212'::uuid,
      '20260525-0000-4000-d000-000000000201'::uuid,
      'Combien font 9 x 6 ?',
      '54',
      '45',
    ...
    (
      '20260525-0000-4000-d000-000000000213'::uuid,
      '20260525-0000-4000-d000-000000000201'::uuid,
    ...
    (
      '20260525-0000-4000-d000-000000000214'::uuid,
      '20260525-0000-4000-d000-000000000201'::uuid,
    ...
    (
      '20260525-0000-4000-d000-000000000215'::uuid,
      '20260525-0000-4000-d000-000000000201'::uuid,
...
draw_settings_seed as (
  ...
  values
    (
      ...
      1,
      2,
      'Ta participation au Jeu Concours Code MegaPromo est enregistree.',
      now() + interval '1 hour',
    ...
    (
      ...
      1,
      2,
      'Ta participation au Jeu Concours Bon Achat est enregistree.',
      now() + interval '1 hour',
      'Deux gagnants seront tires automatiquement a la fin du concours.',
      now()
    ),
    (
      ...
      1,
      2,
      'Ta participation au Jeu Concours Lot Surprise est enregistree.',
      now() + interval '1 hour',
      'Deux gagnants seront tires automatiquement a la fin du concours.',
      now()
    )

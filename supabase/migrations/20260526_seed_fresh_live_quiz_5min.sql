...
-- 4) 20260526_create_start_live_quiz_participation_rpc.sql
-- Inscription ouverte tout de suite; debut du jeu dans 5 minutes.
...
where coalesce(is_live, false) = true
  and id <> '20260526-0000-4000-c000-000000006101'::uuid
...
live_contest as (
  ...
  select
    '20260526-0000-4000-c000-000000006101'::uuid,
    null,
    'QL Express MegaPromo',
    'Quiz Live express de 5 questions. Inscris-toi maintenant avant le depart.',
...
values
  (
    '20260526-0000-4000-d000-000000006111'::uuid,
    '20260526-0000-4000-c000-000000006101'::uuid,
  ...
  (
    '20260526-0000-4000-d000-000000006112'::uuid,
    '20260526-0000-4000-c000-000000006101'::uuid,
  ...
  (
    '20260526-0000-4000-d000-000000006113'::uuid,
    '20260526-0000-4000-c000-000000006101'::uuid,
  ...
  (
    '20260526-0000-4000-d000-000000006114'::uuid,
    '20260526-0000-4000-c000-000000006101'::uuid,
  ...
  (
    '20260526-0000-4000-d000-000000006115'::uuid,
    '20260526-0000-4000-c000-000000006101'::uuid,
    'Que signifie IA ?',
...
where contests.id = '20260526-0000-4000-c000-000000006101'::uuid

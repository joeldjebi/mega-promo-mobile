-- MegaPromo - 1 Quiz Live dans 30 minutes
...
-- cree/met a jour un QL actif qui commence dans 30 minutes.
...
live_contest as (
  ...
  select
    ...
    'Quiz Live synchronise: culture generale, marques et logique. Inscris-toi avant le depart.',
...
values
  (
    '20260526-0000-4000-d000-000000003011'::uuid,
    '20260526-0000-4000-c000-000000003001'::uuid,
  ...
  (
    '20260526-0000-4000-d000-000000003012'::uuid,
    '20260526-0000-4000-c000-000000003001'::uuid,
  ...
  (
    '20260526-0000-4000-d000-000000003013'::uuid,
    '20260526-0000-4000-c000-000000003001'::uuid,
    'Combien font 8 x 7 ?',
    '56',
    '48',
  ...
  (
    '20260526-0000-4000-d000-000000003014'::uuid,
    '20260526-0000-4000-c000-000000003001'::uuid,
  ...
  (
    '20260526-0000-4000-d000-000000003015'::uuid,
    '20260526-0000-4000-c000-000000003001'::uuid,
...
where contests.id = '20260526-0000-4000-c000-000000003001'::uuid

-- MegaPromo - Jeu concours quiz qui se termine dans 1 minute
...
contest_seed as (
  ...
  select
    '20260526-0000-4000-9000-000000000301'::uuid,
    null,
    'Quiz Minute Chrono',
    'Un quiz concours express: joue maintenant, le gagnant est designe dans une minute.',
...
questions_seed as (
  ...
  values
    (
      '20260526-0000-4000-9000-000000000311'::uuid,
      '20260526-0000-4000-9000-000000000301'::uuid,
      'Dans un quiz, que faut-il viser ?',
      'Le meilleur score',
      'La page profil',
      'Le bouton retour',
      'Le mode avion',
    ...
    (
      '20260526-0000-4000-9000-000000000312'::uuid,
      '20260526-0000-4000-9000-000000000301'::uuid,
    ...
    (
      '20260526-0000-4000-9000-000000000313'::uuid,
      '20260526-0000-4000-9000-000000000301'::uuid,
      'Que reçoit le gagnant après désignation ?',
      'Une notification',
      'Une erreur',
      'Un écran vide',
      'Une déconnexion',
...
where contests.id = '20260526-0000-4000-9000-000000000301'::uuid

-- MegaPromo - 1 Quiz Live dans 5 minutes
...
live_contest as (
  ...
  select
    '20260525-0000-4000-c000-000000000951'::uuid,
    null,
    'QL Challenge Express',
    'Un Quiz Live court et rapide: marques, culture generale et logique.',
...
values
  (
    '20260525-0000-4000-c000-000000000961'::uuid,
    '20260525-0000-4000-c000-000000000951'::uuid,
  ...
  (
    '20260525-0000-4000-c000-000000000962'::uuid,
    '20260525-0000-4000-c000-000000000951'::uuid,
  ...
  (
    '20260525-0000-4000-c000-000000000963'::uuid,
    '20260525-0000-4000-c000-000000000951'::uuid,
  ...
  (
    '20260525-0000-4000-c000-000000000964'::uuid,
    '20260525-0000-4000-c000-000000000951'::uuid,
  ...
  (
    '20260525-0000-4000-c000-000000000965'::uuid,
    '20260525-0000-4000-c000-000000000951'::uuid,
...
where contests.id = '20260525-0000-4000-c000-000000000951'::uuid

-- MegaPromo - 5 jeux concours + 1 Quiz Live
...
-- Script idempotent: cloture les QL expires, cree/met a jour 5 jeux concours
-- standards actifs et 1 QL actif qui commence dans 5 minutes.
...
standard_seed as (
  ...
  join (
    values
      (
        '20260525-0000-4000-e000-000000000101'::uuid,
        'Jeu Concours Mobile Money',
        'Participe pour tenter de gagner un credit Mobile Money.',
        'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=1200&q=80',
        '20260525-0000-4000-a000-000000000101'::uuid,
        true
      ),
      (
        '20260525-0000-4000-e000-000000000102'::uuid,
        'Jeu Concours Code Reduction',
        'Tente ta chance pour remporter un code reduction.',
      ...
      (
        '20260525-0000-4000-e000-000000000103'::uuid,
        'Jeu Concours Bon Reduction',
        'Un tirage rapide pour gagner un bon de reduction.',
      ...
      (
        '20260525-0000-4000-e000-000000000104'::uuid,
        'Jeu Concours Ticket Concert',
        'Participe pour tenter de gagner un ticket concert VIP.',
        'https://images.unsplash.com/photo-1501386761578-eac5c94b800a?auto=format&fit=crop&w=1200&q=80',
        '20260525-0000-4000-a000-000000000104'::uuid,
        false
      ),
      (
        '20260525-0000-4000-e000-000000000105'::uuid,
        'Jeu Concours Lot Physique',
        'Tente de remporter un lot physique surprise.',
...
live_seed as (
  ...
  select
    '20260525-0000-4000-e000-000000000201'::uuid,
    null,
    'QL Mega Reflexe',
    'Quiz Live express: sois rapide, juste et reste concentre.',
...
questions_seed as (
  ...
  values
    (
      '20260525-0000-4000-e000-000000000211'::uuid,
      '20260525-0000-4000-e000-000000000201'::uuid,
    ...
    (
      '20260525-0000-4000-e000-000000000212'::uuid,
      '20260525-0000-4000-e000-000000000201'::uuid,
      'Combien font 7 x 8 ?',
      '56',
      '48',
    ...
    (
      '20260525-0000-4000-e000-000000000213'::uuid,
      '20260525-0000-4000-e000-000000000201'::uuid,
    ...
    (
      '20260525-0000-4000-e000-000000000214'::uuid,
      '20260525-0000-4000-e000-000000000201'::uuid,
    ...
    (
      '20260525-0000-4000-e000-000000000215'::uuid,
      '20260525-0000-4000-e000-000000000201'::uuid,
